<?php
/**
 * Web interface for generating the Odsea POT files
 *
 * @since 2.0
 * @package Odsea
...
require './makepot.php';
$makepot = new ODSEA_Makepot;

// Regeneration requested
if ( ! empty( $_GET['generate'] ) ) {
	// Generate odsea and odsea-admin POT files
	$results = array();
...
<head>
	...
	<meta charset="utf-8">
	<title>Odsea POT Generator</title>
	<style>
...
<body>
	...
	<h1>Odsea <?php echo $makepot->odsea_version() ?> POT Generator</h1>
	...
	<p>This tool will (re)generate and overwrite the following Odsea POT-files:</p>
